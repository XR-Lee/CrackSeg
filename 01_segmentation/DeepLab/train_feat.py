...
class Trainer(object):
    ...
    def training(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            # Assuming 'target' is your tensor
            # invalid_items = (target != 0) & (target != 1)

            # Get the indices where the condition is True
            # invalid_indices = torch.nonzero(invalid_items)

            # Print the indices and the corresponding values
            # for idx in invalid_indices:
                # print(f"Invalid value at index {tuple(idx.tolist())}: {target[tuple(idx.tolist())]}")
...
#                 self.summary.visualize_image(self.writer, self.args.dataset, image, target, output, global_step)
    ...
    def validation(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            if (i%2==0):
                global_step = i + num_img_tr * epoch
                self.summary.visualize_image(self.writer, self.args.dataset, image, target_temp, output, global_step)
...
def main():
    ...
    parser.add_argument('--base-size', type=int, default=448,
    ...
    parser.add_argument('--features', action='store_true', default=True,
                        help='adding DINO features to the code')
