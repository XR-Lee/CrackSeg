...
bool Initialize(size_t argc, LPCTSTR* argv)
{
	...
	config.add_options()
		...
		("number-views-fuse", boost::program_options::value(&nMinViewsFuse)->default_value(2), "minimum number of images that agrees with an estimate during fusion in order to consider it inlier")
